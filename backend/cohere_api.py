...
# Import APIs Here
from app.api import yolo_api


app = Flask(__name__)

# Enabling Cross-Origin Resource Sharing (allows Next.js frontend to connect to Flask backend)
CORS(app)

# Register the blueprings (AKA other APIs)
